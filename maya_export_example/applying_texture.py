...
def abc_export(filepath, node=None, start_frame=1, end_frame=1, data_format='ogawa', uv_write=True):
...
def main():
    export_directory = '/path/to/CHARACTER/MyCharacter/abc'
    hair_file = os.path.join(export_directory, 'strands_applying_texture.abc')
    curve_top_group = 'my_description1_splineDescription|SplineGrp0' # After rename, it will be "my_description1_splineDescription|my_description1_splineDescription"
    uv_mesh = 'pPlaneShape1'
